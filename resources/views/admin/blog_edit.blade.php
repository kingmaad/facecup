                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal tasi-form" id="new_post_form" method="post" action="/administrator/post/update" enctype="multipart/form-data">
                                    @if ($errors->any())
                                    ...
                                    <div class="form-group ">
                                        <label for="post_title" class="control-label col-lg-2">عنوان پست</label>
                                        <div class="col-lg-10">
                                            <input class=" form-control" id="title" name="title" value="{{ $post->title }}" type="text" required />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="permalink" class="control-label col-lg-2">permalink</label>
                                        <div class="col-lg-10">
                                            <input class=" form-control text-left" id="permalink" value="{{ $post->permalink }}" name="permalink" type="text" required />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="img" class="control-label col-lg-2">تصویر پست</label>
                                        <div class="col-lg-10">
                                            <img src="{{ asset($post->img) }}" height="50">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea name="body" id="body_editor" required>
                                                {{ $post->body }}
                                            </textarea>
