                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            لیست فرصتهای شخلی
                            <div class="pull-left m-4"><a href="/job_add" class="btn btn-info">اضافه کردن فرصت شغلی جدید</a></div>
                        </header>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary btn-xs" href="/job_edit/{{ $job->id }}"><i class="icon-pencil"></i></a>
