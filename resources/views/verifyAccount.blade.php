              ...
              <div class="row">
                <div class="page-content">
                    <div class="form-v2-content">
                        ...
                        <form class="form-detail" action="/VerifyAccount" method="post" id="otp-validation">

                          <br><br>
                          
                          <h6 class="text-right">تایید شماره موبایل</h6>
                          <div class="form-row text-right">
                              <label for="otp">لطفا کلمه عبور دریافتی از طریق پیامک را وارد نمایید</label>
                              <input type="text" name="otp" id="otp" class="input-text english"  placeholder="کلمه عبور دریافتی را وارد نمایید" required>
                          </div>
                          {{ csrf_field() }}
                          ...
                          <p class="text-center m-4">
                            <a href="/resend" class="btn btn-info">ارسال مجدد کلمه عبور</a>
                          </p>
